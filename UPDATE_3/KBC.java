...
public class KBC{
    ...
    public static void main(String[] args) {
        ...
        // Get the first letter of the player's name to choose their question set
        char firstLetter = Character.toUpperCase(playerName.charAt(0));
        Question[] questions = selectQuestionSet(firstLetter);

        System.out.println("Welcome, " + playerName + "! Let's start the game.");

        // Ensure the player answers exactly 10 questions
    ...
    public static Question[] selectQuestionSet(char firstLetter) {
        // Select a question set based on the first letter of the player's name
        switch (firstLetter) {
            ...
            default: return createQuestionSetDefault();
        }
    }
    ...
    public static void askQuestion(Question question) {
        ...
        questionCount++;
        System.out.println("You have answered " + questionCount + " questions so far.\n");
    }

    // Question sets for each letter of the alphabet (A-Z)
